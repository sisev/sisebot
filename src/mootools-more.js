...
// Load this file's selection again by visiting: http://mootools.net/more/824a29729f310e196d77901f881b5f54 
// Or build this file again with packager using: packager build More/Events.Pseudos More/Class.Refactor More/Class.Binds More/Class.Occlude More/Chain.Wait More/Array.Extras More/Date More/Date.Extras More/Number.Format More/Object.Extras More/String.Extras More/String.QueryString More/URI More/URI.Relative More/Hash More/Hash.Extras More/Element.Forms More/Element.Event.Pseudos More/Element.Event.Pseudos.Keys More/Element.Measure More/Element.Pin More/Element.Position More/Element.Shortcuts More/Fx.Elements More/Fx.Accordion More/Fx.Move More/Fx.Reveal More/Fx.Scroll More/Fx.Slide More/Fx.SmoothScroll More/Fx.Sort More/Request.JSONP More/Assets More/Group More/Hash.Cookie More/Keyboard More/Keyboard.Extras More/Scroller More/Locale.zh-CH.Date
/*
---
copyrights:
...
var e=g.start+b.before.length;if(a!==false){this.selectRange(e,e+d.length);}else{this.setCaretPosition(e+f.length);}}return this;}});(function(){var d={relay:false},c=["once","throttle","pause"],b=c.length;
